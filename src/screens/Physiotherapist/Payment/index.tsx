...
const PhysiotherapistPayment = ({navigation}: any) => {
  ...
  return (
    <Wrapper statusBarBagColor={'transparent'} statusBarStyle={'light-content'}>
      <HeaderCard
        cardColor={colors.Physiotherapist}
        numberOfIcons={'3'}
        onPress={openDrawer}
        icon1={LabMenu}
        tintColor={colors.background}>
        <UserHeaderContent
          ScreenTitle={'Patient Payment'}
          ColorScreenTitle={colors.primary}
          searhIconTrue
          tintColor={colors.background}
          searhIconTr
          tintTr={colors.background}
          onlySearchIcon
        />
      </HeaderCard>
      <View
          ...
          {DoctorsRequestsItems.map((item, index) => (
            <TouchableOpacity
              ...
              style={{
                ...
                padding: RF(16),
                borderRadius: RF(8),
                borderLeftColor: colors.Physiotherapist,
                borderLeftWidth: 2,
                marginVertical: RF(8),
              }}>
              <Text size={16} SFmedium color={colors.Physiotherapist}>
                {`${item.paymentId}`}
              </Text>
              <View
                style={{
              ...
              <View
                ...
                <Image
                  ...
                  style={{
                    width: RF(16),
                    height: RF(16),
                    tintColor: colors.Physiotherapist,
                  }}
                />
              </View>
              <TouchableOpacity>
...
export default PhysiotherapistPayment;
