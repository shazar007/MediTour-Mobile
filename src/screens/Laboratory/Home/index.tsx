...
import {drawer, LabBell, LabMenu, LaboratoryBackground} from '@assets';
...
const LaboratoryHome = ({navigation}: any) => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      dispatch(setChangeColor(colors.orange));
    }, []),
  );
